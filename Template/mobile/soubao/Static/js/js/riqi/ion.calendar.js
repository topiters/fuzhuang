                    ...
                    if(settings.sundayFirst) {
                        ...
                        for(i = 1; i <= monthLastDay; i++) {
                            ...
                            if(moment(timeNowLocal).date(i).format("D.M.YYYY") === timeNow.format("D.M.YYYY")) {
                                html += '<td class="ic__day ic__day_state_current"><button disabled="disabled">' + i + '</button></td>';
                            } else if(timeSelected && moment(timeNowLocal).date(i).format("D.M.YYYY") === timeSelected.format("D.M.YYYY")) {
                                html += '<td class="ic__day ic__day_state_selected"><button>' + i + '</button></td>';
                            } else {
                                html += '<td class="ic__day"><button>' + i + '</button></td>';
                            }
        ...
        init: function(options){
            ...
            return this.each(function(){
                ...
                var openPopup = function(){
					...
					$popup.css("left", x+"px").css("top", (y + 30)+"px");
