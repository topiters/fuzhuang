...
class GoodsLogic extends RelationModel
{
    ...
    {            
        ...
        if($cat['parent_id_path'] == '')
        {
            ...
            $GoodsCategory->execute("UPDATE __PREFIX__goods_category AS a ,tp_goods_category AS b SET a.parent_id_path = CONCAT_WS('_',b.parent_id_path,'$id'),a.level = (b.level+1) WHERE a.parent_id=b.id AND a.id = $id");                
