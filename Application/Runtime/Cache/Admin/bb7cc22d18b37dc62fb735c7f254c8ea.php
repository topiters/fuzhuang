            ...
            <div class="navbar navbar-default">
                <div class="row navbar-form">
                    <div class="pull-right">
                        <a data-original-title="资金调节" class="btn btn-primary" title="" data-toggle="tooltip" href="<?php echo U('Admin/User/account_edit',array('id'=>$user_id));?>"><i class="fa fa-pencil"></i></a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                    <td class="text-left"><?php echo (date("Y-m-d H:i",$list["change_time"])); ?></td>
